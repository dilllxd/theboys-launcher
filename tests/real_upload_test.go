...
func TestRealUpload(t *testing.T) {
	...
	// Approach 1: Basic form upload (new implementation)
	t.Run("BasicForm", func(t *testing.T) {
		testBasicFormUpload(t, content)
	})

	// Approach 2: With TLS 1.2 explicitly set
	t.Run("TLS12Form", func(t *testing.T) {
		testTLS12FormUpload(t, content)
	})

	// Approach 3: With explicit content type for form data
	t.Run("ExplicitContentType", func(t *testing.T) {
		testExplicitContentTypeFormUpload(t, content)
	})

	// Approach 4: Combined approach (TLS 1.2 + explicit content type)
	t.Run("CombinedApproach", func(t *testing.T) {
		testCombinedApproachFormUpload(t, content)
	})
}

func testBasicFormUpload(t *testing.T, content []byte) {
	fmt.Println("Testing basic form upload...")
...
func testTLS12FormUpload(t *testing.T, content []byte) {
	fmt.Println("Testing TLS 1.2 form upload...")
...
func testExplicitContentTypeFormUpload(t *testing.T, content []byte) {
	fmt.Println("Testing explicit content type form upload...")
...
func testCombinedApproachFormUpload(t *testing.T, content []byte) {
