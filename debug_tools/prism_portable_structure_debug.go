...
func main() {
	if len(os.Args) < 2 {
		...
		fmt.Println("  - If URL is provided, it will download and analyze the portable build")
		fmt.Println("  - If directory is provided, it will analyze the extracted build")
		os.Exit(1)
	}
	...
	if strings.HasPrefix(input, "http://") || strings.HasPrefix(input, "https://") {
		// Download and analyze the portable build
